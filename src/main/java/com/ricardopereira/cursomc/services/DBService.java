...
import com.ricardopereira.cursomc.domain.Cidade;
import com.ricardopereira.cursomc.domain.Cliente;
import com.ricardopereira.cursomc.domain.Endereco;
import com.ricardopereira.cursomc.domain.Estado;
import com.ricardopereira.cursomc.domain.ItemPedido;
import com.ricardopereira.cursomc.domain.Pagamento;
import com.ricardopereira.cursomc.domain.PagamentoComBoleto;
import com.ricardopereira.cursomc.domain.PagamentoComCartao;
...
import com.ricardopereira.cursomc.domain.enums.TipoCliente;
import com.ricardopereira.cursomc.repositories.CategoriaRepository;
import com.ricardopereira.cursomc.repositories.CidadeRepository;
import com.ricardopereira.cursomc.repositories.ClienteRepository;
import com.ricardopereira.cursomc.repositories.EnderecoRepository;
import com.ricardopereira.cursomc.repositories.EstadoRepository;
...
import com.ricardopereira.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p1,p2,p3, p4, p5, p5, p7, p8, p9, p10,p11));
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","teste@gmail.com","36378912377",TipoCliente.PESSOAFISICA, pe.encode("123456"));
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/017 19:35"),cli1, e2);
