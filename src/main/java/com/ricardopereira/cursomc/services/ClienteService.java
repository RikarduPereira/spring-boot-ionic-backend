...
import com.ricardopereira.cursomc.dto.ClienteDTO;
...
import com.ricardopereira.cursomc.services.exceptions.DataIntegretyException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegretyException("Não é possível excluir um Cliente que tenha pedidos");
		}
